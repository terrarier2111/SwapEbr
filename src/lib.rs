...
pub use crate::swap_arc::{ArcGuard, SwapArc};
...
mod swap_box {
    ...
    use crate::{cleanup_box, epoch::{pin, retire_explicit, Guarded, LocalPinGuard}};
...
mod swap_arc {
    ...
    use crate::{cleanup_arc, epoch::{pin, retire_explicit, Guarded, LocalPinGuard}};
